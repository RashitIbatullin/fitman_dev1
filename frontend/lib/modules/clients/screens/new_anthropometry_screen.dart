...
class NewAnthropometryScreen extends ConsumerStatefulWidget {
  final String? clientId;
  const NewAnthropometryScreen({super.key, this.clientId});

  @override
  ConsumerState<NewAnthropometryScreen> createState() =>
      _NewAnthropometryScreenState();
}

class _NewAnthropometryScreenState extends ConsumerState<NewAnthropometryScreen>
