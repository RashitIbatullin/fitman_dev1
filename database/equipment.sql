...
(8, 'ФИТ-001', NULL, 'Anti-Burst', 'Ledraplastik', 5, 'Корзина с мячами', 0, 5, '2023-04-01', 3000.00, 'Фитбол 65 см'),
(9, 'КОВ-001', NULL, 'Professional', 'Manduka', 5, 'Стеллаж для ковриков', 0, 5, '2023-04-01', 2500.00, 'Коврик для йоги 5мм'),
(10, 'ВЕС-001', 'SN123463', 'BF-350', 'Beurer', 1, 'У входа', 0, 5, '2023-05-10', 8000.00, 'Электронные весы');
...
-- ============================================
-- 4. СООБЩЕНИЕ ОБ УСПЕШНОМ ВЫПОЛНЕНИИ
-- ============================================
