...
_$EquipmentMaintenanceHistoryImpl _$$EquipmentMaintenanceHistoryImplFromJson(
  ...
  executorType: const ExecutorTypeConverter().fromJson(
    (json['executor_type'] as num?)?.toInt(),
  ),
...
Map<String, dynamic> _$$EquipmentMaintenanceHistoryImplToJson(
  ...
  'executor_type': const ExecutorTypeConverter().toJson(instance.executorType),
